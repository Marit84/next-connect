...
this.setState({ [event.target.name]: inputValue });
  ...
  handleSubmit = event => {
    ...
    .then(updatedUser => {
      this.setState({ updatedUser, openSucess: true })
  ...
  handelClose = () => this.setState({ openError: false });
  ...
  render() {
    ...
    const { name, email, avatar, avatarPreview, about, isLoading, isSaving, updatedUser, openSucess, openError, error } = this.state;
